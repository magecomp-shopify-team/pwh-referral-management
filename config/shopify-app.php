...
return [
    ...
    */
    ...
    'app_handle' => env('SHOPIFY_APP_HANDLE', 'pwh-custom-app'),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', 'read_products,write_products,read_online_store_pages,read_content,read_customers,write_customers,read_discounts,write_discountsm,read_orders,write_orders,read_fulfillments'),
    ...
    */
    ...
    'webhooks' => [
        ...
        [
            'topic' => env('SHOPIFY_WEBHOOK_3_TOPIC', 'FULFILLMENTS_CREATE'),
            'address' => env('SHOPIFY_WEBHOOK_3_ADDRESS', 'https://(your-domain).com/webhook/fulfillment-created')
        ],
